            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.operands = new ArrayList<Expression>(_list62.size);
                Expression _elem63;
                for (int _i64 = 0; _i64 < _list62.size; ++_i64)
                {
                  _elem63 = new Expression();
                  _elem63.read(iprot);
                  struct.operands.add(_elem63);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.operands != null) {
        if (struct.isSetOperands()) {
          oprot.writeFieldBegin(OPERANDS_FIELD_DESC);
          {
            ...
            for (Expression _iter65 : struct.operands)
            {
              _iter65.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetOperands()) {
        {
          ...
          for (Expression _iter66 : struct.operands)
          {
            _iter66.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.operands = new ArrayList<Expression>(_list67.size);
          Expression _elem68;
          for (int _i69 = 0; _i69 < _list67.size; ++_i69)
          {
            _elem68 = new Expression();
            _elem68.read(iprot);
            struct.operands.add(_elem68);
          }
        }
        struct.setOperandsIsSet(true);
      }
