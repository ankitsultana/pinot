...
public class PassThroughSendingMailbox implements SendingMailbox<BaseDataBlock> {
  private final PassThroughChannel<BaseDataBlock> _channel;
  private final String _mailboxId;

  public PassThroughSendingMailbox(String mailboxId, PassThroughChannel<BaseDataBlock> channel) {
  ...
  @Override
  public void send(BaseDataBlock data)
