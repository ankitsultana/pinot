...
public class SortPushdownRule extends PRelOptRule {
  ...
  public PRelNode onMatch(PRelOptRuleCall call) {
    ...
    PRelNode n2 = new PRelNode(call._physicalPlannerContext.getNextId(), newExchangeInput,
        o2.getPinotDataDistribution(), ImmutableList.of(o2), o2.isLeafStage(), o2.isLeafStageBoundary());
    PRelNode n1 = new PRelNode(o1.getNodeId(), newExchange, o1.getPinotDataDistribution(), ImmutableList.of(n2),
        o1.isLeafStage(), o2.isLeafStageBoundary());
    // return n0
