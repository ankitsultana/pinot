...
public class InstanceRequest implements org.apache.thrift.TBase<InstanceRequest, InstanceRequest._Fields>, java.io.Serializable, Cloneable, Comparable<InstanceRequest> {
  ...
  private static final org.apache.thrift.protocol.TField RIGHT_SEARCH_SEGMENTS_FIELD_DESC = new org.apache.thrift.protocol.TField("rightSearchSegments", org.apache.thrift.protocol.TType.LIST, (short)6);
  ...
  private List<String> rightSearchSegments; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    RIGHT_SEARCH_SEGMENTS((short)6, "rightSearchSegments");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // BROKER_ID
          return BROKER_ID;
        case 6: // RIGHT_SEARCH_SEGMENTS
          return RIGHT_SEARCH_SEGMENTS;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.SEARCH_SEGMENTS,_Fields.ENABLE_TRACE,_Fields.BROKER_ID,_Fields.RIGHT_SEARCH_SEGMENTS};
  ...
  static {
    ...
    tmpMap.put(_Fields.BROKER_ID, new org.apache.thrift.meta_data.FieldMetaData("brokerId", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.RIGHT_SEARCH_SEGMENTS, new org.apache.thrift.meta_data.FieldMetaData("rightSearchSegments", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
  ...
  public InstanceRequest(InstanceRequest other) {
    ...
    if (other.isSetRightSearchSegments()) {
      List<String> __this__rightSearchSegments = new ArrayList<String>(other.rightSearchSegments);
      this.rightSearchSegments = __this__rightSearchSegments;
    }
  }
  ...
  public int getRightSearchSegmentsSize() {
    return (this.rightSearchSegments == null) ? 0 : this.rightSearchSegments.size();
  }

  public java.util.Iterator<String> getRightSearchSegmentsIterator() {
    return (this.rightSearchSegments == null) ? null : this.rightSearchSegments.iterator();
  }

  public void addToRightSearchSegments(String elem) {
    if (this.rightSearchSegments == null) {
      this.rightSearchSegments = new ArrayList<String>();
    }
    this.rightSearchSegments.add(elem);
  }

  public List<String> getRightSearchSegments() {
    return this.rightSearchSegments;
  }

  public void setRightSearchSegments(List<String> rightSearchSegments) {
    this.rightSearchSegments = rightSearchSegments;
  }

  public void unsetRightSearchSegments() {
    this.rightSearchSegments = null;
  }

  /** Returns true if field rightSearchSegments is set (has been assigned a value) and false otherwise */
  public boolean isSetRightSearchSegments() {
    return this.rightSearchSegments != null;
  }

  public void setRightSearchSegmentsIsSet(boolean value) {
    if (!value) {
      this.rightSearchSegments = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RIGHT_SEARCH_SEGMENTS:
      if (value == null) {
        unsetRightSearchSegments();
      } else {
        setRightSearchSegments((List<String>)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case RIGHT_SEARCH_SEGMENTS:
      return isSetRightSearchSegments();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(InstanceRequest that) {
    ...
    boolean this_present_rightSearchSegments = true && this.isSetRightSearchSegments();
    boolean that_present_rightSearchSegments = true && that.isSetRightSearchSegments();
    if (this_present_rightSearchSegments || that_present_rightSearchSegments) {
      if (!(this_present_rightSearchSegments && that_present_rightSearchSegments))
        return false;
      if (!this.rightSearchSegments.equals(that.rightSearchSegments))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_rightSearchSegments = true && (isSetRightSearchSegments());
    list.add(present_rightSearchSegments);
    if (present_rightSearchSegments)
      list.add(rightSearchSegments);
  ...
  public int compareTo(InstanceRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetRightSearchSegments()).compareTo(other.isSetRightSearchSegments());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRightSearchSegments()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.rightSearchSegments, other.rightSearchSegments);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetRightSearchSegments()) {
      if (!first) sb.append(", ");
      sb.append("rightSearchSegments:");
      if (this.rightSearchSegments == null) {
        sb.append("null");
      } else {
        sb.append(this.rightSearchSegments);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class InstanceRequestStandardScheme extends StandardScheme<InstanceRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.searchSegments = new ArrayList<String>(_list0.size);
                String _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rightSearchSegments = new ArrayList<String>(_list3.size);
                String _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = iprot.readString();
                  struct.rightSearchSegments.add(_elem4);
                }
                iprot.readListEnd();
              }
              struct.setRightSearchSegmentsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InstanceRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.searchSegments != null) {
        if (struct.isSetSearchSegments()) {
          oprot.writeFieldBegin(SEARCH_SEGMENTS_FIELD_DESC);
          {
            ...
            for (String _iter6 : struct.searchSegments)
            {
      ...
      if (struct.rightSearchSegments != null) {
        if (struct.isSetRightSearchSegments()) {
          oprot.writeFieldBegin(RIGHT_SEARCH_SEGMENTS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.rightSearchSegments.size()));
            for (String _iter7 : struct.rightSearchSegments)
            {
  ...
  private static class InstanceRequestTupleScheme extends TupleScheme<InstanceRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, InstanceRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSearchSegments()) {
        {
          ...
          for (String _iter8 : struct.searchSegments)
          {
      ...
      if (struct.isSetRightSearchSegments()) {
        {
          oprot.writeI32(struct.rightSearchSegments.size());
          for (String _iter9 : struct.rightSearchSegments)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.searchSegments = new ArrayList<String>(_list10.size);
          String _elem11;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.rightSearchSegments = new ArrayList<String>(_list13.size);
          String _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = iprot.readString();
            struct.rightSearchSegments.add(_elem14);
          }
        }
        struct.setRightSearchSegmentsIsSet(true);
      }
