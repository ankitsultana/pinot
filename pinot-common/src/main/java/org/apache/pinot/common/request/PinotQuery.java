...
public class PinotQuery implements org.apache.thrift.TBase<PinotQuery, PinotQuery._Fields>, java.io.Serializable, Cloneable, Comparable<PinotQuery> {
  ...
  private static final org.apache.thrift.protocol.TField JOIN_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("joinInfo", org.apache.thrift.protocol.TType.STRUCT, (short)14);
  ...
  private Map<Expression,Expression> expressionOverrideHints; // optional
  private JoinInfo joinInfo; // optional
  ...
  private static final _Fields optionals[] = {_Fields.VERSION,_Fields.DATA_SOURCE,_Fields.SELECT_LIST,_Fields.FILTER_EXPRESSION,_Fields.GROUP_BY_LIST,_Fields.ORDER_BY_LIST,_Fields.HAVING_EXPRESSION,_Fields.LIMIT,_Fields.OFFSET,_Fields.DEBUG_OPTIONS,_Fields.QUERY_OPTIONS,_Fields.EXPLAIN,_Fields.EXPRESSION_OVERRIDE_HINTS,_Fields.JOIN_INFO};
  ...
  static {
    ...
    tmpMap.put(_Fields.EXPRESSION_OVERRIDE_HINTS, new org.apache.thrift.meta_data.FieldMetaData("expressionOverrideHints", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "Expression"), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "Expression"))));
    tmpMap.put(_Fields.JOIN_INFO, new org.apache.thrift.meta_data.FieldMetaData("joinInfo", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "JoinInfo")));
  ...
  public PinotQuery(PinotQuery other) {
    ...
    if (other.isSetExpressionOverrideHints()) {
      Map<Expression,Expression> __this__expressionOverrideHints = new HashMap<Expression,Expression>(other.expressionOverrideHints.size());
      for (Map.Entry<Expression, Expression> other_element : other.expressionOverrideHints.entrySet()) {

        Expression other_element_key = other_element.getKey();
        Expression other_element_value = other_element.getValue();

        Expression __this__expressionOverrideHints_copy_key = other_element_key;

        Expression __this__expressionOverrideHints_copy_value = other_element_value;
  ...
  public void putToExpressionOverrideHints(Expression key, Expression val) {
    if (this.expressionOverrideHints == null) {
      this.expressionOverrideHints = new HashMap<Expression,Expression>();
    }
  ...
  public void setExpressionOverrideHints(Map<Expression,Expression> expressionOverrideHints) {
  ...
  public void unsetJoinInfo() {
    this.joinInfo = null;
  }

  /** Returns true if field joinInfo is set (has been assigned a value) and false otherwise */
  public boolean isSetJoinInfo() {
    return this.joinInfo != null;
  }

  public void setJoinInfoIsSet(boolean value) {
    if (!value) {
      this.joinInfo = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EXPRESSION_OVERRIDE_HINTS:
      if (value == null) {
        ...
        setExpressionOverrideHints((Map<Expression,Expression>)value);
      }
      break;
  ...
  public boolean equals(PinotQuery that) {
    ...
    boolean this_present_joinInfo = true && this.isSetJoinInfo();
    boolean that_present_joinInfo = true && that.isSetJoinInfo();
    if (this_present_joinInfo || that_present_joinInfo) {
      if (!(this_present_joinInfo && that_present_joinInfo))
        return false;
      if (!this.joinInfo.equals(that.joinInfo))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_expressionOverrideHints = true && (isSetExpressionOverrideHints());
    list.add(present_expressionOverrideHints);
    if (present_expressionOverrideHints)
      list.add(expressionOverrideHints);

    boolean present_joinInfo = true && (isSetJoinInfo());
    list.add(present_joinInfo);
    if (present_joinInfo)
      list.add(joinInfo);
  ...
  public int compareTo(PinotQuery other) {
    ...
    lastComparison = Boolean.valueOf(isSetExpressionOverrideHints()).compareTo(other.isSetExpressionOverrideHints());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetJoinInfo()).compareTo(other.isSetJoinInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetJoinInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.joinInfo, other.joinInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class PinotQueryStandardScheme extends StandardScheme<PinotQuery> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.expressionOverrideHints = new HashMap<Expression,Expression>(2*_map17.size);
                Expression _key18;
                Expression _val19;
          ...
          case 14: // JOIN_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.joinInfo = new JoinInfo();
              struct.joinInfo.read(iprot);
              struct.setJoinInfoIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PinotQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.debugOptions != null) {
        if (struct.isSetDebugOptions()) {
          oprot.writeFieldBegin(DEBUG_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter24 : struct.debugOptions.entrySet())
            {
      ...
      if (struct.queryOptions != null) {
        if (struct.isSetQueryOptions()) {
          oprot.writeFieldBegin(QUERY_OPTIONS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter25 : struct.queryOptions.entrySet())
            {
      ...
      if (struct.expressionOverrideHints != null) {
        if (struct.isSetExpressionOverrideHints()) {
          oprot.writeFieldBegin(EXPRESSION_OVERRIDE_HINTS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Expression, Expression> _iter26 : struct.expressionOverrideHints.entrySet())
            {
      ...
      if (struct.joinInfo != null) {
        if (struct.isSetJoinInfo()) {
          oprot.writeFieldBegin(JOIN_INFO_FIELD_DESC);
          struct.joinInfo.write(oprot);
          oprot.writeFieldEnd();
        }
      }
      ...
      if (struct.isSetDebugOptions()) {
        {
          ...
          for (Map.Entry<String, String> _iter30 : struct.debugOptions.entrySet())
          {
      ...
      if (struct.isSetQueryOptions()) {
        {
          ...
          for (Map.Entry<String, String> _iter31 : struct.queryOptions.entrySet())
          {
      ...
      if (struct.isSetExpressionOverrideHints()) {
        {
          ...
          for (Map.Entry<Expression, Expression> _iter32 : struct.expressionOverrideHints.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.selectList = new ArrayList<Expression>(_list33.size);
          Expression _elem34;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.groupByList = new ArrayList<Expression>(_list36.size);
          Expression _elem37;
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.orderByList = new ArrayList<Expression>(_list39.size);
          Expression _elem40;
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.debugOptions = new HashMap<String,String>(2*_map42.size);
          String _key43;
          String _val44;
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.queryOptions = new HashMap<String,String>(2*_map46.size);
          String _key47;
          String _val48;
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.expressionOverrideHints = new HashMap<Expression,Expression>(2*_map50.size);
          Expression _key51;
          Expression _val52;
