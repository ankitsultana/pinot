...
public class DataSource implements org.apache.thrift.TBase<DataSource, DataSource._Fields>, java.io.Serializable, Cloneable, Comparable<DataSource> {
  ...
  private PinotQuery subquery; // optional
  ...
  public void setSubquery(PinotQuery subquery) {
  ...
  public int hashCode() {
    ...
    boolean present_subquery = true && (isSetSubquery());
    list.add(present_subquery);
    if (present_subquery)
      list.add(subquery);
  ...
  public int compareTo(DataSource other) {
    ...
    lastComparison = Boolean.valueOf(isSetSubquery()).compareTo(other.isSetSubquery());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubquery()) {
