...
//    return subPlanMap.get(0);
  ...
  public static Pair<SubPlan, PlanFragmentAndMailboxAssignment.Result> makePlanV2(RelRoot relRoot,
      PhysicalPlannerContext physicalPlannerContext, TableCache tableCache) {
    PRelNode pRelNode = RelToPRelConverter.toPRelNode(relRoot.rel, physicalPlannerContext, tableCache);
